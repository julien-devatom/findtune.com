                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            ...
                            <input name="title" id="title" className="form-control w-100" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="content">Content</label>
                            <textarea name="content" id="content" className="form-control w-100" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="video_url">Add a video url</label>
                            <input name="video_url" id="video_url" className="form-control w-100" />
                        </div>

                    </div>
                    <div className="modal-footer">
                        <button type="button" className="btn btn-primary mr-auto" data-dismiss="modal">Close</button>
                        <button type="submit" className="btn btn-success">Add a post</button>
                    </div>
                </div>
                </form>
            </div>
